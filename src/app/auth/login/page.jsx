...
export default function Login() {
  return (
    <section className="bg-gradient-to-r from-slate-900 to-slate-700 min-h-screen">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-gradient-to-r from-slate-900 to-slate-700 border-gray-700">
